...
$sql2 ="INSERT INTO student (`name`,`age`,`password`,`email`,`address`,`phone`,`gender`)VALUE('Naseeb Khan','45','00543','khan1213@gmail.com','Peshawar','03000000000','Male')";
  ...
  <body>
    <div class="bgnd pt-5">
        <div class="container-sm ">
            ...
            <form action="/action_page.php" class="bg-light rad">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-5">
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="phone-number" placeholder="03XX-XXXXXXX" name="phone-number">
                      </div>
                    </div>
                    <div class="col-5">
                      <div class="mb-3">
